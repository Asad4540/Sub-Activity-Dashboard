    ...
    <div class="px-5 mt-4">
        <div class="tabs-card d-flex">
            <div class="nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                ...
                <button class="nav-link" id="subscribersGrowth-tab" data-bs-toggle="pill"
            ...
            <div class="tab-content tab-wrapper" id="v-pills-tabContent">
                ...
                <div class="tab-pane fade " id="subscribersGrowth" role="tabpanel">
                    <div>
                ...
                <div class="tab-pane fade " id="performanceMetrics" role="tabpanel">
                    <p> <span class="settings-title">Performance Metrics </span><hr>
                    </p><br>
                    <div class="px-4">
                        <form action="">
                ...
                <div class="tab-pane fade " id="trafficSources" role="tabpanel">
                    <p> <span class="settings-title"> Traffic Sources</span><hr>
                    </p><br>
                    <div class="px-4">
